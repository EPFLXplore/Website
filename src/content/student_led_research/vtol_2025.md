...
sections:
  - title: "Overview"
    ...
    media:
      - type: "image"
        src: "vtol_2025.png"
        alt: "Retractable-wing VTOL prototype"

  - title: "Why Retractable Wings?"
    bullets:
      - "Compact hover configuration to maneuver in cluttered spaces and pass through tight gaps."
      - "Wing-borne cruise for improved range/endurance vs. pure multirotor flight."
      - "Exploration-oriented concept: reach places a rover can’t, especially in constrained terrain; the proposal even discusses dense-atmosphere planetary scenarios (e.g., Titan/Venus)."
    media:
      - type: "image"
        src: "vtol_2025.png"
        alt: "Concept: folded vs deployed wing modes"
  ...
  - title: "Wing Mechanism"
    ...
    body:
      - "Two families were explored: fabric-based concepts (high folding ratio but weak profile stability) vs. rigid-cell concepts (heavier but true aerodynamic shape). The final design adopts rigid cells with a scissor linkage and mechanical nesting to keep the surface continuous when deployed."
    bullets:
  ...
  - title: "Aerodynamics & Validation"
    ...
    media:
      - type: "image"
        src: "vtol_2025.png"
        alt: "WindShape tests and aerodynamic evaluation"
  ...
  - title: "What’s Next"
    subtitle: "Concrete improvements identified for a flight-capable iteration."
    bullets:
      - "Re-size hover propulsion for the true mass (or redesign propulsion to avoid separate cruise motor)."
      - "Reduce drag and mass by removing takeoff/landing poles and improving structural integration."
      - "Improve leading-edge closure and seal gaps between cells to recover lift lost to leakage."
      - "Consider retractable tail / telescopic fuselage section to further shrink the hover footprint."
    media:
      - type: "image"
        src: "vtol_2025.png"
        alt: "Next-iteration directions"
